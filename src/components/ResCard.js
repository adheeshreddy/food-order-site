...
//    console.log(props);
       return (
           <div className="card w-80 items-center rounded-xl  transition-transform duration-400 hover:scale-95">
               <img className="resimg w-full h-52 p-3 border-t-2 border-x-2 object-cover rounded-3xl bg-gradient-to-t from-black to-transparent" src={IMG_URL+resdata.info.cloudinaryImageId}></img>
